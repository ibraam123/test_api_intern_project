...
class _ProductApiService implements ProductApiService {
  ...
  @override
  Future<ProductsResponse> getProducts(String token) async {
  ...
  @override
  Future<SingleProductResponse> getProductById(String id, String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SingleProductResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SingleProductResponse _value;
    try {
      _value = SingleProductResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
